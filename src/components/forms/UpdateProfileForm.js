import { Paper, TextField, Button, Snackbar, Alert, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Typography } from '@mui/material'
...
function UpdateProfileForm() {
    ...
    const handleProfileUpdate = () => {
        ...
        axios.put("http://localhost:5000/userprofile", data, {
            headers: {
                'Authorization': `Bearer ${token}`
            }
        }).then((response) => {
    ...
    return (
        <Paper elevation={3} sx={{
            ...
            <Typography variant='h6' component="h5">Update Profile</Typography>
            <TextField
                id="Profession"
                rows={4}
                margin="dense"
            ...
            <Button variant="contained" disabled={loading ? true : false} color='primary' onClick={handleDialogOpen}>Update</Button>
