...
function DiaryEntryForm() {
    ...
    useEffect(() => {
        axios.get(`https://3.26.97.225:5000/v1/dairy/entrybytoday`,
         {
            headers: {
    ...
    const updateEntries = () => {
        axios.put("https://3.26.97.225:5000/v1/user/incrementEntries",{} ,{
            headers: {
                'Authorization': `Bearer ${token}`
            }
        }).then((response) => {
    ...
    const handleEntrySubmit = (event) => {
        ...
        console.log(text);
        axios.post("https://3.26.97.225:5000/v1/dairy/entry", {
            "entry": text
        },
            {
                headers: {
